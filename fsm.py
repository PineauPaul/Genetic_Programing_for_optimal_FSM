...
"""
#############################################################################seek
#self==> attribut de classe et attribut d'objet.
...
class fsm(object):
    ...
    def checkStability(self):
        """is the sum of all heading order (positive angle only) is less than 90degree by n then the fsm is stable."""
        return sum(self._states) <= len(self._states)*np.pi/2
